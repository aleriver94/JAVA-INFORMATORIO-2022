...
public class Ejercicio4 {
    private static String bienvenida =
            "Bienvenido, dada una lista de enteros, obtendremos otra lista aplicando el factorial sin valores repetidos.";
    ...
    public static void calcularFactorialNoRepeat(List<Integer> palabras) {
        List<Integer> list = palabras.stream().map(x -> factCalculator(x.intValue())).distinct()
